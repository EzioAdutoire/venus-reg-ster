...
const tag = '⟁'   
const erkekrol = message.guild.roles.cache.find(r => r.id === '823185204646641665') //erkek rol id
const erkekrol2 = message.guild.roles.cache.find(r => r.id === '823185205425864725')//erkek rol 2 id
const erkekrol3 = message.guild.roles.cache.find(r => r.id === '823185206575104010')//erkek rol 3 id
const kayıtsız = message.guild.roles.cache.find(r => r.id === '823185211356348446')//kayıtsız id
const genelchat = message.guild.channels.cache.find(c => c.id === '823185290671030313')//genelchat id
