...
if(!['823185191665008661'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = '⟁'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '823185202200313887') //kadın rol id
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '823185203374850079')//kadın rol2 id
const kadınrol3 = message.guild.roles.cache.find(r => r.id === '823185203815251979')//kadın rol3 id
const kayıtsız = message.guild.roles.cache.find(r => r.id === '823185211356348446')//kayıtsız rol id
const genelchat = message.guild.channels.cache.find(c => c.id === '823185290671030313')//genel chat id
const savelog = message.guild.channels.cache.find(c => c.id === '823185323554766858')//savelog id
